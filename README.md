...
Your task is to implement a console application that would take the morse code as input and return a decoded human-readable string.
...
The solution shall be implemented in a TDD way and published as (public) repository on a github.com account.

Bonus: each commit should be properly commented and it should show that the implementation is really TDD.
